<script setup> 
useHead({
    title: 'Contacto - Jefre Massingue',
//     meta: [
      ...
      <div class="flex flex-wrap -mx-4 lg:justify-between">
         <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div data-aos="fade-right" data-aos-duration="1000" class="mb-12 max-w-[570px] lg:mb-0">
               ...
               <h2
                  class="text-white mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                  >
                  Tem uma ideia de projecto. Vamos trabalhar juntos!
               </h2>
               <p
                  class="text-base leading-relaxed text-zinc-100 mb-9"
                  >
               ...
               <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                     ...
                     <p class="text-base text-zinc-200">
                        Moçambique, Maputo - Bairro Laulane
                     </p>
                  </div>
               </div>
               <div class="mb-8 flex w-full max-w-[370px]">
